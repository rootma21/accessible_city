...
children_311 = [
    html.Br(),
    html.H1(dcc.Markdown('**Locating Hotspots for Sidewalk Service Requests**')),
...
app.layout = html.Div([
    dcc.Tabs([
        dcc.Tab(label="About Compatible City",
                id="tab-home", children=children_home),
